      ...
      <div className="mt-8">
        ...
        <div className="mt-6">
          <div className="relative">
            <div className="absolute w-full border-gray-300 border-t" />
            <div className="relative -top-3 text-center">
              <span className="bg-slate-400 px-2 text-sm text-gray-500">
                Or enter with
              </span>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3 mt-6">
            <button className="flex justify-center items-center py-2 px-4 border-gray-600 border-2 rounded-md shadow-sm bg-slate-400 text-sm font-medium text-gray-700 hover:bg-gray-50">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
