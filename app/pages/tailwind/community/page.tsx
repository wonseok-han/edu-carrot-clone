  ...
  return (
    <Layout hasTabBar>
      <div className="py-16 space-y-8">
        {[1, 2, 3, 4, 5, 7].map((_, i) => (
          <Link key={i} href={`pages/tailwind/community/${i}`}>
        ...
        <Link href={`pages/tailwind/community/write`}>
          <button className="fixed hover:bg-orange-500 cursor-pointer transition-colors bottom-24 right-20 shadow-xl bg-orange-400 rounded-full p-4 text-white">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
